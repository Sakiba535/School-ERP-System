    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Else
                ...
                MessageBox.Show("Invalid activation id...Please contact software provider for buying full licence" & vbCrLf & "Contact us at :" & vbCrLf & "Sarp Services Pvt Ltd" & vbCrLf & "Email-Sales@sarp.in" & vbCrLf & "Mobile No. +919246530588", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)

            End If
        Catch ex As Exception
            ' MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show("Failed to connect to sql server", "Server not running..Activation failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
